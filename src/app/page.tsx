    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-center px-6 pt-24 pb-16 lg:px-12">
        <div className="mx-auto w-full max-w-5xl">
          ...
          {/* Heading */}
          <h1 className="max-w-3xl font-serif text-4xl font-semibold leading-tight tracking-tight text-card sm:text-5xl md:text-6xl lg:text-7xl text-balance">
            Strengthening Our Community, Together
          </h1>

          {/* Subheading */}
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-card/80 md:text-xl">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <Link
              href="#volunteer"
              className="rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-xl"
            >
              Become a Volunteer
            </Link>
            <Link
              href="#services"
              className="rounded-full border border-card/30 bg-card/10 px-8 py-3.5 text-base font-semibold text-card backdrop-blur-sm transition-all hover:bg-card/20"
            >
              Our Services
            </Link>
          </div>
...
function StatCard({
  ...
  return (
    <div className="flex items-center gap-4 rounded-xl border border-card/10 bg-card/10 px-5 py-4 backdrop-blur-sm">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/20 text-primary-foreground">
        {icon}
      </div>
      <div>
